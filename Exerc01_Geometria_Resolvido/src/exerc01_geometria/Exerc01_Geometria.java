...
public class Exerc01_Geometria {
    ...
    public static void main(String[] args) {
        ...
        TrianguloRetangulo tr1 = new TrianguloRetangulo(10,10,24,35);
        tr1.cateto1 = 10;

        //✅ TODO 13 escreva como comentário: por que aconteceu um erro na criação do objeto?
        // R : Esse problema acontece quando a Classe Trianguloretangulo não está no mesmo pacote e a classe está
        //     no modo default, o que impossibilita ser visto fora do pacote.

        //✅ TODO 14 escreva como comentário: o que pode ser feito para resolver o erro?
        // R : Colocar a classe como pública ou pode mover o algoritmo do TrianguloRetangulo para esta classe.
        ...
        // R : Por que a Classe está em outro pacote e preciso ser importado.
        ...
        //✅ TODO 19 escreva como comentário: é possível realizar esta atribuição?
        // R : Porque os atributos estão com acesso default (package-private).

        // TODO 20 escreva como comentário: o que pode ser feito para resolver este erro?
        // R : Para resolver este problema será necessário fazer o encapsulamento e usar getters e setters.
